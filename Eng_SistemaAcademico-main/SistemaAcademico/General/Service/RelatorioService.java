...
public class RelatorioService {
    ...
    public void gerarRelatorioDeNotas(Turma turma) {
        ...
        for (AlunoTurma alunoTurma : turma.getAlunos()) {
            System.out.println("Aluno: " + alunoTurma.getAluno().getNome() + ", Nota: " + alunoTurma.getNota() + ", Situação: " + alunoTurma.getSituacao());
        }
        System.out.println();
    }
    ...
    public void gerarRelatorioDeFrequencia(Turma turma) {
        ...
        System.out.println("----------------------------------------------------");
        for (AlunoTurma alunoTurma : turma.getAlunos()) {
            System.out.println("Aluno: " + alunoTurma.getAluno().getNome() + ", Frequência: " + alunoTurma.getFrequencia() + "%");
        }
        System.out.println();
        System.out.println("****************************************************************************************************************************");
        System.out.println();
